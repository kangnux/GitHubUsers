...
open class UsersAPI {
     ...
     */
    open class func requestUser(completion: @escaping ((_ data: GitUserInfo?,_ error: Error?) -> Void)) {
        requestUserWithRequestBuilder().execute { (response, error) -> Void in
     ...
     */
    open class func requestUser() -> Observable<GitUserInfo> {
        return Observable.create { observer -> Disposable in
            requestUser() { data, error in
                if let error = error {
  ...
  "node_id" : "MDQ6VXNlcjE="
     ...
     */
    open class func requestUserWithRequestBuilder() -> RequestBuilder<GitUserInfo> {
        let path = "/user"
